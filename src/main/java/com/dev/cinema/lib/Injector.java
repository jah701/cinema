...
public class Injector {
    ...
    public Object getInstance(Class certainInterface) throws InvocationTargetException {
    ...
    private Object getNewInstance(Class certainClass) throws InvocationTargetException {
